package com.cesi.library_project.providers.ui.table;
...
public class TableForm extends AbstractComponentProvider<Table> {
    ...
    public void implement(@NotNull Composite composite) {
        ...
        buttonSubmit.addMouseListener(new MouseListener() {
            ...
            public void mouseUp(MouseEvent mouseEvent) {
                ...
                Table music = new Table (duration1, metaData);
